...
export const NODES: PassiveNode[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    nodeType: 'small',
    region: 'volume',
    description: 'Every roll has a 3% chance to grant a bonus roll.',
    notation: [[val('3%'), to(), roll()]],
    costs: { score: 45 },
    prerequisites: ['start'],
    position: { x: 48, y: 199 },
    tags: ['bonus-roll'],
    modifiers: [{ stat: 'bonusRollChance', op: 'add', value: 0.03 }],
  },
  {
    id: 'vl_lowgear',
    name: 'Low Gear',
  ...
  },
  {
    ...
    nodeType: 'small',
    region: 'volume',
    description: 'Bonus rolls have an 3% chance to grant a further bonus roll.',
    notation: [[roll('bonus'), to('3%'), roll()]],
    costs: { score: 250 },
    prerequisites: ['vl_lowgear'],
    position: { x: 21, y: 505 },
    tags: ['bonus-roll'],
    modifiers: [{ stat: 'bonusFromBonusChance', op: 'add', value: 0.03 }],
  },
  {
    id: 'vl_echo',
    name: 'Echo',

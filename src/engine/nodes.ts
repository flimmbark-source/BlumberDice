...
export const NODES: PassiveNode[] = [
  ...
  },
  {
    ...
    costs: { score: 580 },
    prerequisites: ['ct_reserve', 'pt_collector'],
    position: { x: -447, y: 145 },
  ...
  },
  {
    ...
    prerequisites: ['jp_stake', 'ct_hold'],
    position: { x: -118, y: 204 },
  ...
  },
  {
    ...
    prerequisites: ['vl_quick', 'ad_counterweight'],
    position: { x: 235, y: 0 },
